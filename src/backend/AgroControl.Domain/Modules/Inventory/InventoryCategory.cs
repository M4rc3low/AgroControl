...
public sealed class InventoryCategory
{
    ...
    private InventoryCategory(Guid id, Guid organizationId, string name, DateTime createdAtUtc)
    {
        Id = id;
    ...
    public static InventoryCategory Create(Guid organizationId, string name, DateTime nowUtc)
    {
        ...
        return new InventoryCategory(Guid.NewGuid(), organizationId, name.Trim(), nowUtc);
    }
