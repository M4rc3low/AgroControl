...
public sealed class ModuleCatalog : IModuleCatalog
{
    ...
    [
        ...
        new(ModuleKey.Machinery, "Machinery", ModuleStatus.ComingSoon, "Máquinas, combustível e manutenção."),
        new(ModuleKey.Market, "Market", ModuleStatus.ComingSoon, "Mercado, preços e commodities."),
        new(ModuleKey.PrecisionAgriculture, "Precision Agriculture", ModuleStatus.Locked, "Mapas, drones e agricultura de precisão."),
        new(ModuleKey.Intelligence, "Agro Intelligence", ModuleStatus.Locked, "Análise de dados, previsão e IA."),
