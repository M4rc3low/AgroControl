...
class TelemetryIngestionServiceTests {
    ...
    void mqtt_ingestion_uses_registered_device_tenant_not_payload_tenant() {
        ...
        var service = new TelemetryIngestionService(devices, events, new ObjectMapper());
    ...
    void rejects_payload_with_two_values() {
        var service = new TelemetryIngestionService(mock(DeviceRepository.class), mock(TelemetryEventRepository.class), new ObjectMapper());
